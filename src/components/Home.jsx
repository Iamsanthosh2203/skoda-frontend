...
import image13 from '../assets/images/image (2).jpg'
        ...
        <>
                ...
                <Row className='mb-3 w-100'>
                    ...
                    <Col className='p-0 w-100' >
                        <div className='img-tile my-3 p-4 text-start' style={{ minWidth: '105%' }} >
                            ...
                            <p className='img-para  mt-3'>
                            Elevate your living space with Skoda Home Decors' exquisite furniture collection. Transform your home into a haven of style and comfort with our meticulously crafted pieces. Whether you seek classic elegance or modern flair, our diverse range of furniture complements every taste and interior design.                            <div className='mt-3 text-center'>
            ...
            <Container className='my-5 py-5'>
                <Row xs={1} md={3} className='text-start'>
                    ...
                    <Col className='my-3'>
                        <div className="lorem">
                        Skoda Furnitures and Timbers offer a captivating fusion of style and functionality. Their designs are a testament to innovation, with an intriguing blend of modern aesthetics and timeless craftsmanship. Each piece in their collection exudes a unique character, setting them apart in the world of interior design.                        </div></Col>
                    <Col className='my-3'>
                        <div className="lorem">
                        Skoda Furnitures and Timbers are not just pieces of furniture; they are a reflection of individuality and taste. With a focus on quality materials and thoughtful design, these pieces are more than just functional; they are a statement of luxury and sophistication. Experience the allure of Skoda Furnitures and Timbers, where every piece is a masterpiece in the world of interior design.
                ...
                <Row xs={1} md={2}>
                    ...
                    <Col className='p-0 m-0'>
                        <div className='contnr text-start'>
                            ...
                            <iframe width={'100%'} height="315" src="https://www.youtube.com/embed/bl-O3KhNmF0?si=Hcm19HfQ0_qIUcDV" title="YouTube video player" 
                            ...
                            <div class="bottom-right">
                                ...
                                Comfortable, stylish, durable, perfect for any space                                </div>
                            </div>
                        </div>
                    </Col>
                ...
                <Row xs={1} md={2}>
                    ...
                    <Col className='px-0' >
                        <div className="bg-dark p-5 text-start">
                            ...
                            "Transform your life with Skoda Home Decors, where furniture becomes a catalyst for change. Our exquisite pieces redefine your living spaces, making them inviting, functional, and stylish. Elevate your home with our diverse selection and experience the power of furniture to enhance your life. Discover the Skoda difference today."                            </div>
            ...
            <Container fluid className='p-5' style={{backgroundColor:'rgba(25, 27, 29, 0.53)'}}>
                <Row xs={1} md={4}>
                    <Col className='my-3'>
                        ...
                        <div className="num-line">Workers</div>
                    </Col>
                    <Col className='my-3'>
                        <div className="num">600+</div>
                        <div className="num-line">Products</div>
                    </Col>
                    <Col className='my-3'>
                        <div className="num">150+</div>
                        <div className="num-line">Models</div>
                    </Col>
                    <Col className='my-3'>
                        <div className="num">2</div>
                        <div className="num-line">Stores</div>
                    </Col>
