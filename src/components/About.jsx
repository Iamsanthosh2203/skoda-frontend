...
import image17 from '../assets/images/image (4).jpg'
function About() {
    return (
        <div>
                ...
                <Row className='about-row ' xs={1} md={2}>
                    ...
                    <Col className='p-5'>
                        <div className="about text-start p-5">
                            ...
                            Welcome to Skoda Home Decors, where we transform houses into homes through our passion for design and commitment to excellence. Our journey began with a simple vision: to provide our customers with top-notch home decor solutions that inspire and delight. With years of experience in the interior design and home decor industry, we have established ourselves as a trusted name in the field, known for our dedication to enhancing your living spaces.                            </div>
                            <div className="">
            ...
            <Container className='my-5'>
                <Row xs={1} md={2} className='my-5'>
                    ...
                    <Col className='px-2'>
                        <Row className='my-3'>
                            ...
                            Skoda Home Decors offers a diverse range of high-quality home decor products, including furniture, lighting, textiles, wall art, and accessories. We source our products from artisans and manufacturers who share our commitment to quality and sustainability.                            </div>
                        </Row>
                        <Row>
                            <Col>
                                <div className="yellow ">
                            ...
                            <div className="p-yellow text-start my-3">
                            Our team of skilled designers and craftsmen are the backbone of our success. They possess a wealth of knowledge and expertise in interior design, home decor, and furnishings. With an acute eye for detail and a passion for aesthetics, they work tirelessly to craft bespoke solutions that cater to your specific requirements and preferences.                            </div>
                        </Row>
                    </Col>
                </Row>
                ...
                We look forward to embarking on this exciting journey with you, turning your house into a place that truly feels like home. Explore our collections, consult with our design experts, and experience the Skoda Home Decors difference.                </div>
            </Container>
                ...
                <Row xs={1} md={2} className='bg-light rounded'>
                    <Col className='p-4'>
                        <form className='text-start' >
                            ...
                            <p>
                            Your dream home awaits. Contact us today and let's make it a reality together.
                            </p>
                            ...
                            <Row className='my-3'>
                                <Col className='mx-3'>
                                    <Row className=''>
                                        ...
                                        <Col>
                                            <h3>Phone</h3>
                                            <p className="text-danger">+91 9895592008</p>
                                            <p className="text-danger">+91 9495845786</p>
                                        </Col>
                                    </Row>
                                </Col>
                                <Col>
                                    <Row>
                                        ...
                                        <Col>
                                            <h3>E-MAIL</h3>
                                            <p className="text-danger">skodahomedecor@gmail.com</p>
                                            <p className="text-danger">skodatimbers@gmail.com</p>
                                        </Col>
                                    </Row>
                                </Col>
                            </Row>
